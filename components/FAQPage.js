...
//   const faqs = [
//     {
//       question: "How can I submit my music to Essential Music?",
//       answer: "We accept music submissions through our online portal. Please ensure your submission includes high-quality recordings, artist biography, and press materials. Our A&R team reviews all submissions and will contact you if interested."
//     },
//     {
//       question: "What genres do you work with?",
//       answer: "We work across all genres, from electronic and pop to rock and classical. Our focus is on quality and innovation rather than specific genres. We're always looking for unique voices and fresh approaches to music."
//     },
//     {
//       question: "How do your artist contracts work?",
//       answer: "Our contracts are tailored to each artist's needs and circumstances. We believe in fair, transparent agreements that benefit both parties. Standard contracts typically cover recording, distribution, and marketing support."
//     },
//     {
//       question: "Do you offer distribution-only deals?",
//       answer: "Yes, we offer various partnership models, including distribution-only deals. These arrangements give artists more control while leveraging our global distribution network and marketing expertise."
//     },
//     {
//       question: "What support do you provide to artists?",
//       answer: "We provide comprehensive support including recording facilities, marketing, PR, tour support, digital strategy, and sync licensing. Our team works closely with each artist to develop customized career strategies."
//     }
//   ];
...
//             className="text-6xl font-bold mb-24 text-center tracking-tight"
//           >
...
//             <p className="text-gray-400 mb-8">Our team is here to help. Reach out to us anytime.</p>
//             <motion.button
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
//               className="bg-white text-black px-8 py-4 rounded-full font-bold inline-flex items-center"
//             >
//               Contact Support
